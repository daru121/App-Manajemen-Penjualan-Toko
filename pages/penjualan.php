...
if (isset($_GET['action']) && $_GET['action'] === 'print_receipt') {
    ...
    // Get current server time in WITA
    $current_time = new DateTime('now', new DateTimeZone('Asia/Makassar'));
    $formatted_time = $current_time->format('d/m/Y H:i');
    ...
    $pdf->Cell(2, 4, ':', 0, 0, 'L');
    $pdf->Cell(0, 4, $formatted_time . ' WITA', 0, 1, 'L');
...
<head>
    ...
    <link rel="stylesheet" href="../src/css/penjualan.css">
</head>
